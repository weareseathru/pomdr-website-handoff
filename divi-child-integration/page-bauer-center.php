...
.here-card h3{font-family:var(--font-serif);font-size: 25px;font-weight:500;margin:0 0 8px;}
.here-card p{font-size: 21px;color:var(--ink-2);margin:0;line-height:1.6;}
...
.visit-band p{font-size: 23px;color:var(--ink-2);margin:0 0 18px;line-height:1.7;}
