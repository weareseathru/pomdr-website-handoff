  ...
  <div class="container">
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(320px,1fr));gap:28px">
      <article class="card" style="padding:0;overflow:hidden">
        ...
        <div style="padding:20px"><div class="eyebrow">Adoption story</div><h2 style="font-family:var(--font-serif);font-size:20px;margin:6px 0 0">Pebble's first week home</h2></div>
      </article>
      <article class="card" style="padding:0;overflow:hidden">
        <div style="aspect-ratio:16/9;background:var(--cream-2);display:grid;place-items:center;color:var(--ink-3)">video placeholder</div>
        <div style="padding:20px"><div class="eyebrow">Behind the scenes</div><h2 style="font-family:var(--font-serif);font-size:20px;margin:6px 0 0">A morning at the Bauer Center</h2></div>
      </article>
      <article class="card" style="padding:0;overflow:hidden">
        <div style="aspect-ratio:16/9;background:var(--cream-2);display:grid;place-items:center;color:var(--ink-3)">video placeholder</div>
        <div style="padding:20px"><div class="eyebrow">Helping Paw</div><h2 style="font-family:var(--font-serif);font-size:20px;margin:6px 0 0">Walking brigade at work</h2></div>
      </article>
    </div>
