...
.foster-story__name { font-family: var(--font-serif); font-size: 27px; font-weight: 500; margin: 0 0 8px; color: var(--ink); }
.foster-story__quote { font-size: 21px; line-height: 1.62; color: var(--ink-2); margin: 0; }
.foster-lede { max-width: 74ch; font-size: 23px; line-height: 1.7; color: var(--ink-2); }
