...
<section class="section">
  <div class="container">
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:28px">
      <article class="card" style="padding:24px"><div class="eyebrow">Health</div><h2 style="font-family:var(--font-serif);font-size:22px;margin:8px 0 12px">Vet care for senior dogs</h2><p style="color:var(--ink-3);font-size:15px">Twice-a-year exams, blood panels, dental, pain management. What to ask your vet.</p></article>
      <article class="card" style="padding:24px"><div class="eyebrow">Mobility</div><h2 style="font-family:var(--font-serif);font-size:22px;margin:8px 0 12px">Stairs, rugs, slippery floors</h2><p style="color:var(--ink-3);font-size:15px">Small home tweaks that make a huge difference for a dog with arthritis or hind-end weakness.</p></article>
      <article class="card" style="padding:24px"><div class="eyebrow">Behavior</div><h2 style="font-family:var(--font-serif);font-size:22px;margin:8px 0 12px">Cognitive changes</h2><p style="color:var(--ink-3);font-size:15px">When a senior dog seems confused at night, or stops settling on a familiar bed.</p></article>
      <article class="card" style="padding:24px"><div class="eyebrow">Nutrition</div><h2 style="font-family:var(--font-serif);font-size:22px;margin:8px 0 12px">Feeding a senior dog</h2><p style="color:var(--ink-3);font-size:15px">Calorie counts, joint supplements, and what to do when a dog gets picky.</p></article>
      <article class="card" style="padding:24px"><div class="eyebrow">End of life</div><h2 style="font-family:var(--font-serif);font-size:22px;margin:8px 0 12px">Quality of life</h2><p style="color:var(--ink-3);font-size:15px">A framework for the hardest conversations. Hospice options, in-home services, grief support.</p></article>
      <article class="card" style="padding:24px"><div class="eyebrow">Finance</div><h2 style="font-family:var(--font-serif);font-size:22px;margin:8px 0 12px">Help paying for vet care</h2><p style="color:var(--ink-3);font-size:15px">Local and national funds for medical bills, including our own Helping Paw program.</p></article>
    </div>
  </div>
</section>
