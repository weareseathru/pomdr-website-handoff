...
<section class="section" id="how">
  <div class="container">
    ...
    <div class="steps-2col">
      <div class="step-row"><span class="step-num">01</span><div><h3 style="font-family:var(--font-serif);font-size: 29px;font-weight:500;margin:0 0 8px">Apply</h3><p style="color:var(--ink-2);margin:0">Tell us about your home, your schedule, and the kind of dog you can welcome. We read every application personally.</p></div></div>
      <div class="step-row"><span class="step-num">02</span><div><h3 style="font-family:var(--font-serif);font-size: 29px;font-weight:500;margin:0 0 8px">Match</h3><p style="color:var(--ink-2);margin:0">We pair you with a dog whose needs and energy fit your life. Senior, hospice, medical recovery, or short-term respite.</p></div></div>
      <div class="step-row"><span class="step-num">03</span><div><h3 style="font-family:var(--font-serif);font-size: 29px;font-weight:500;margin:0 0 8px">We cover the big costs</h3><p style="color:var(--ink-2);margin:0">Vet care and medication, fully covered. Donated food and supplies as available. You provide the couch and the love.</p></div></div>
...
<section class="section" id="provides" style="background:var(--cream-2)">
  <div class="container">
    ...
    <div class="steps-2col">
      ...
      <div class="step-row"><span class="step-num">02</span><div><h3 style="font-family:var(--font-serif);font-size: 29px;font-weight:500;margin:0 0 8px">POMDR covers the vet care</h3><p style="color:var(--ink-2);margin:0">We cover all medical expenses for your foster dog. You never pay a vet bill.</p></div></div>
      <div class="step-row"><span class="step-num">03</span><div><h3 style="font-family:var(--font-serif);font-size: 29px;font-weight:500;margin:0 0 8px">You provide a safe, loving home</h3><p style="color:var(--ink-2);margin:0">We ask foster homes to provide a loving, safe place to land until the dog is adopted. Donated food and supplies are available to help.</p></div></div>
