...
.hero-card h3{font-family:var(--font-serif);font-size: 25px;font-weight:400;margin:0 0 12px;color:#fff;}
.hero-card p{font-size: 21px;color:rgba(255,255,255,.8);margin:0 0 18px;}
...
.option-card h3{font-family:var(--font-serif);font-size: 27px;font-weight:500;margin:0 0 8px;}
.option-card p{font-size: 21px;color:var(--ink-2);margin:0 0 14px;flex:1;}
.opt-link{display:inline-flex;align-items:center;gap:6px;font-size: 21px;font-weight:600;color:var(--blue);margin-top:auto;}
...
.perpetual-section p{color:rgba(255,255,255,.85);font-size: 21px;margin:0 0 18px;}
...
.perp-num{font-family:var(--font-serif);font-size: 31px;font-weight:300;color:var(--purple-100);line-height:1;flex-shrink:0;width:32px;}
.perp-step h4{font-family:var(--font-serif);font-size: 22px;font-weight:500;margin:0 0 5px;}
.perp-step p{font-size: 21px;opacity:.8;margin:0;}
...
.perp-cta h3{font-family:var(--font-serif);font-size: 23px;font-weight:400;margin:0 0 10px;}
.perp-cta p{font-size: 21px;opacity:.8;margin:0 0 16px;}
...
.quote-band blockquote{font-family:var(--font-serif);font-size:clamp(25px, 3vw, 41px);font-weight:300;font-style:italic;line-height:1.2;letter-spacing:-.015em;max-width:760px;margin:0 auto 16px;color:var(--blue-900);}
.quote-band cite{font-size: 20px;letter-spacing:.18em;text-transform:uppercase;color:var(--ink-3);}
/* FAQ */
...
.faq-item h4{font-family:var(--font-serif);font-size: 23px;font-weight:500;margin:0 0 10px;}
.faq-item p{font-size: 21px;color:var(--ink-2);margin:0;}
...
<section class="section">
  <div class="container">
    <div style="font-size: 22px;letter-spacing:.2em;text-transform:uppercase;font-weight:600;color:var(--blue);display:inline-flex;align-items:center;gap:10px;margin-bottom:16px;"><span style="width:24px;height:1px;background:var(--blue-700);display:inline-block;"></span>Placing Your Dog</div>
    ...
    <div class="options-grid">
      <div class="option-card featured">
        ...
        <div style="font-size: 21px;padding-top:16px;border-top:1px solid rgba(255,255,255,.2);color:rgba(255,255,255,.65);margin-bottom:16px;">We are rarely able to accept dogs outside our tri-county area.</div>
        <div style="font-size: 21px;color:rgba(255,255,255,.8);margin-bottom:16px;" lang="es">Si necesita ayuda para colocar a su perro y para completar el cuestionario de admisi&oacute;n en l&iacute;nea, ll&aacute;menos al (831) 718-9122. Tenga en cuenta que esto puede retrasar el procesamiento de su solicitud.</div>
      ...
      <div class="option-card">
        ...
        <div style="font-size: 21px;color:var(--ink-3);padding-top:16px;border-top:1px dashed var(--line);margin-bottom:16px;">Your dog stays with you while listed; adopters contact you directly.</div>
      ...
      <div class="option-card">
        ...
        <div style="font-size: 21px;color:var(--ink-3);padding-top:16px;border-top:1px dashed var(--line);margin-bottom:16px;">Available to seniors and people with disabilities in our tri-county area.</div>
...
<section class="process-section">
  <div class="container">
    <div class="process-intro">
      <div>
        <div style="font-size: 22px;letter-spacing:.2em;text-transform:uppercase;font-weight:600;color:var(--blue);display:inline-flex;align-items:center;gap:10px;margin-bottom:16px;"><span style="width:24px;height:1px;background:var(--blue-700);display:inline-block;"></span>The Process</div>
...
<section class="section">
  <div class="container">
    <div style="font-size: 22px;letter-spacing:.2em;text-transform:uppercase;font-weight:600;color:var(--blue);display:inline-flex;align-items:center;gap:10px;margin-bottom:16px;"><span style="width:24px;height:1px;background:var(--blue-700);display:inline-block;"></span>If Your Dog Is Accepted</div>
...
<section class="faq-section">
  <div class="container">
    <div style="font-size: 22px;letter-spacing:.2em;text-transform:uppercase;font-weight:600;color:var(--blue);display:inline-flex;align-items:center;gap:10px;margin-bottom:16px;"><span style="width:24px;height:1px;background:var(--blue-700);display:inline-block;"></span>Common Questions</div>
