...
.hero-card p{font-size: 16px;color:rgba(255,255,255,.8);margin:0 0 18px;}
...
.opt-link{display:inline-flex;align-items:center;gap:6px;font-size: 16px;font-weight:600;color:var(--blue);margin-top:auto;}
...
.perp-step p{font-size: 16px;opacity:.8;margin:0;}
...
.quote-band cite{font-size: 15px;letter-spacing:.18em;text-transform:uppercase;color:var(--ink-3);}
/* FAQ */
    ...
    <div class="ph-split">
      <div class="ph-text">
        ...
        <div style="display:flex;gap:12px;flex-wrap:wrap;">
          <a href="/intake-questionnaire/" style="background:var(--blue-700);color:#fff;padding:16px 26px;border-radius:999px;font-weight:600;font-size: 16px;display:inline-flex;align-items:center;gap:10px;transition:all .25s;box-shadow:0 10px 24px -6px rgba(0,139,176,.5);">
            Start the Process
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M13 5l7 7-7 7"/></svg>
          </a>
          <a href="#perpetual" style="background:rgba(255,255,255,.1);color:#fff;border:1px solid rgba(255,255,255,.25);padding:16px 26px;border-radius:999px;font-weight:600;font-size: 16px;display:inline-flex;align-items:center;gap:10px;transition:all .25s;">Learn About Perpetual Care</a>
        </div>
  ...
  <div class="container">
    ...
    <div class="options-grid">
      ...
      <div class="option-card">
        ...
        <div style="font-size: 16px;color:var(--ink-3);padding-top:16px;border-top:1px dashed var(--line);margin-bottom:16px;">Available to seniors and people with disabilities in our tri-county area.</div>
