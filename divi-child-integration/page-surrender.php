...
.option-card.featured{background:var(--blue);color:#fff;border-color:var(--blue);}
...
<section class="section">
  <div class="container">
    <div style="font-size:17px;letter-spacing:.2em;text-transform:uppercase;font-weight:600;color:var(--blue);display:inline-flex;align-items:center;gap:10px;margin-bottom:16px;"><span style="width:24px;height:1px;background:var(--blue);display:inline-block;"></span>Placing Your Dog</div>
    ...
    <div class="options-grid">
      ...
      <div class="option-card">
        <div class="opt-icon" style="background:#FFF5E8;color:#C06B00;"><svg viewBox="0 0 24 24"><path d="M22 12s-2.5 7-10 7S2 12 2 12s2.5-7 10-7 10 7 10 7z"/><circle cx="12" cy="12" r="3"/></svg></div>
...
<section class="process-section">
  <div class="container">
    <div style="font-size:17px;letter-spacing:.2em;text-transform:uppercase;font-weight:600;color:var(--blue);display:inline-flex;align-items:center;gap:10px;margin-bottom:16px;"><span style="width:24px;height:1px;background:var(--blue);display:inline-block;"></span>The Process</div>
...
<section class="faq-section">
  <div class="container">
    <div style="font-size:17px;letter-spacing:.2em;text-transform:uppercase;font-weight:600;color:var(--blue);display:inline-flex;align-items:center;gap:10px;margin-bottom:16px;"><span style="width:24px;height:1px;background:var(--blue);display:inline-block;"></span>Common Questions</div>
